...
D.cer.drill = svg(340,168,'中式隊列基本動作示意圖',
  ...
  +T(0,-40,'腳尖向外約 45°',9.5,'#2E7D32')
  +T(0,22,'兩脚跟靠攏',9.5,'#666')+'</g>'
  +T(48,112,'A 立正',11,'#333',null,1)+T(48,128,'挺胸收腹・兩手垂貼',9.5,'#8D6E63')
  /* B 童軍動作：後面睇 */
  ...
  +T(0,-28,'步幅約75cm',9.5,'#2E7D32')
  +'</g>'
  +T(290,112,'C 齊步——走',11,'#333',null,1)
  +T(290,128,'左腳先行・兩臂擺動',9.5,'#8D6E63')
  +T(170,158,'口令：預令＋動令分開嗌（「齊步——走！」）；實際動作以領袖示範為準',10,'#8D6E63')
);
