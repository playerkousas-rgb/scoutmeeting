...
CEREMONY.cards = [
  {
    ...
    icon:'🎌',
    fig:'open',
    figcap:'場景示意：小隊各自排橫隊・小隊長企自己小隊右前方・負責領袖面向全團・團旗喺右側（想照位排布：展開下面「平面／位置圖解」）',
    rel:['c01'],
    duration:'約 5 分鐘',
    when:'每次集會開始，全體集合後進行',
    steps:[
  ...
  },
  {
    ...
    icon:'🇨🇳',
    fig:'flag',
    figcap:'場景示意（由全團後面睇）：中央旗桿較高掛國旗、側邊較矮掛區旗・旗手護旗立桿旁・全體面向旗桿行禮；戴帽行三指禮、無帽注目。旗面只係色塊，實際國旗／區旗樣式以《隊列和升掛國旗及區旗指引》為準',
    rel:['c04'],
    duration:'約 5–8 分鐘',
  ...
  },
  {
    ...
    icon:'🤲',
    fig:'oath',
    figcap:'場景示意：團旗中央・團長對新成員（舉右手、為佢結旅巾）・資深團員持旗旁立・家長前排坐見證・全團後方圍馬蹄形；對應 c06 完整流程',
    rel:['c06'],
    duration:'約 10–15 分鐘',
  ...
  },
  {
    ...
    icon:'✋',
    fig:'salute',
    figcap:'全禮（大禮）正面示意：三指並攏伸直貼右眉／帽沿・拇指壓住小指・手心向前略向下。半禮＝同一手勢但手停喺肩高（離肩一拳、手心向下）——兩個動作都要領袖逐個執手，睇圖唔夠',
    rel:['c04'],
    duration:'練習 3–5 分鐘',
    when:'課程或每次集會小隊時間練習',
    types:[
