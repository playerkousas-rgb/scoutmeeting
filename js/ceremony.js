...
{ h:'1. 立正〔手冊第3章§2〕', dgm:'attn', dgmc:'立正・腳位 30 度・握拳（第3章§2）', d:'口令「<b>Alert！</b>」：兩腳掌平放地面、腳尖向外分開<strong>與中線成 30 度角</strong>（即兩腳尖之間約 60 度；舊版寫 45 度係錯）；雙膝蹬直；<strong>雙手握拳</strong>、手踭蹬直、母指指甲向前放喺食指上面、母指壓住褲骨；身體挺直、後顎繫貼衣領、眼望無限遠。⚠️ 手冊註明：Attention／Squad Shun／Parade Shun 動作跟立正一樣，但只適用於典禮、訓練班或其他制服團體，<strong>一般童軍集會不建議用</strong>——集會就嗌「立正（Alert）」。' },
      ...
      { h:'5. 睇齊（中式「向右看——齊」）', d:'排好之後先喊「向右——看」，隊員用<strong>右眼睺齊右邊隊員嘅左邊眼</strong>（中式口號），頭摆返正就喊「向前——看」。要領同手冊嘅 <i>Right — DRESS</i> 一樣：手踭貼住隔離隊員、身軀挺直、腳尖對齊；小隊長行前一步檢查。⚠️ 排長要調位置就用橫移，唔准長距離跑位。' },
      ...
      { h:'8. 集合／解散／取消口令〔中式＋手冊〕', d:'「集隊——集合」／「解散」等口令及手號必須由領袖或小隊長下達，動作整齊（解散見手冊第6章§8）。想取消頭先個口令，用「<strong>As you were</strong>（取消口令）」：隊員即刻回復先前姿勢（手冊述語定義）。' },
...
{ h:'1. 距離同跟手動作〔第8章概言〕', d:'司令員與最前排隊員相距 <strong>2250 毫米（90 英吋）</strong>。隊排好之後大家<strong>仍要保持立正</strong>，直至司令員<strong>放下雙手</strong>，先一次過由立正轉為稍息。' },
      ...
      { h:'4. 空行（人唔啱數）〔第6章§1〕', d:'「BLANK — FILE!」打數 One — Two — Up — One — Two。例：排五行欠一名 → 企 R4 嘅隊員向左橫移兩步，佢橫移第一步（喊 Up）之後，C4 隊員向後移一步，兩人要同時到定位。原則：留空<strong>最左手邊數起第二行</strong>嘅中排（或中排＋後排）。' },
      ...
      { h:'7. 解散', d:'集會埋尾就係「<b>Dismiss!</b>（解散）」— 一聽到就可以郁／走；啱啱個口令想放返鬆用「<b>As you were!</b>（取消口令）」，隊員自己返返去剛才嘅姿勢，唔使再喊立正。<br>⚠️ 有受禮者在場、或升旗禮後嘅正式解散（要先行進間敬禮再散開）屬進階程序：請照《步操手冊》第6章§8，唔好靠呢張卡。' }
    ],
    types:[
