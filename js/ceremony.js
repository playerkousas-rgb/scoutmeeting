...
CEREMONY.cards = [
  ...
  },
  {
    ...
    icon:'🎖️',
    fig:'drill',
    figcap:'三格要領：A 立正（側身：腳跟靠攏腳尖開 45°・手貼褲縫）· B 童軍動作（從後面睇：右手疊左手、拇指扣緊）· C 齊步（左腳先行 75cm）——照住圖逐個示範，唔好淨係讀文字',
    rel:['c01','c02'],
  ...
  },
  {
    ...
    icon:'🇨🇳',
    fig:'flag',
    figcap:'場景示意（由全團後面睇）：中央旗桿較高掛國旗、側邊較矮掛區旗・旗手護旗立桿旁・全體面向旗桿；戴帽行三指禮、無帽注目。旗面只係色塊示意，實際樣式以《隊列和升掛國旗及區旗指引》為準',
    rel:['c04'],
    duration:'約 5–8 分鐘',
