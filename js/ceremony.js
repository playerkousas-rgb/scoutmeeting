...
CEREMONY.cards = [
  {
    ...
    icon:'🎌',
    fig:'open',
    figcap:'集隊隊列俯視圖：小隊排橫隊、小隊長企右前方、負責領袖面向全團、團旗喺右側',
    rel:['c01'],
    duration:'約 5 分鐘',
    when:'每次集會開始，全體集合後進行',
    steps:[
  ...
  },
  {
    ...
    icon:'🏁',
    fig:'close',
    figcap:'結束五步流程圖：收拾→宣佈→回顧表揚→降旗→敬禮解散（家长交接未完成唔准走）',
    rel:['c01'],
    duration:'約 5 分鐘',
  ...
  },
  {
    ...
    icon:'🎖️',
    fig:'drill',
    figcap:'三個動作要領示意圖：A 立正（腳位俯視）· B 童軍動作（後面睇手位）· C 齊步（左腳先行 75cm）——照住圖逐個示範，唔好淨係讀文字',
    rel:['c01','c02'],
  ...
  },
  {
    ...
    icon:'🇨🇳',
    fig:'flag',
    figcap:'升旗禮平面圖：國旗喺中央且高於區旗、旗手護旗立於桿旁、全體面向旗桿；戴帽行三指禮、無帽注目',
    rel:['c04'],
    duration:'約 5–8 分鐘',
  ...
  },
  {
    ...
    icon:'🤲',
    fig:'oath',
    figcap:'宣誓儀式站位圖：團旗中央、團長對新成員、家長前排見證、全團後方包圍；對應 c06 完整流程',
    rel:['c06'],
    duration:'約 10–15 分鐘',
  ...
  },
  {
    ...
    icon:'✋',
    fig:'salute',
    figcap:'三指手勢正面圖＋全禮／半禮高度圖：三指並攏伸直、拇指壓住小指；全禮指尖齊眉、半禮手齊肩',
    rel:['c04'],
    duration:'練習 3–5 分鐘',
    when:'課程或每次集會小隊時間練習',
    types:[
